...
def sql_query_revisions(current_wiki):
	return """(SELECT * FROM %s_p.revision
	""" % (current_wiki.replace("-", "_") + "wiki")
...
#lang_query=[sql_query_revisions(lang) for lang in lang_list]
#query_all = "UNION ALL\n".join(lang_query)
#query_all = query_all + ";"
